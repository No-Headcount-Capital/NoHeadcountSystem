...
\begin{frame}{Dashboard \& GUI}
    \begin{itemize}
        \item \textbf{Graphical User Interface}: Built via \texttt{order\_monitor.py} to provide intuitive operational status.
        \item \textbf{Core Functions}:
        \begin{itemize}
            \item \textbf{Real-time Metrics}: Overview of order volume, fills, and rejections.
            \item \textbf{Dynamic Grids}: Tracks order lifecycles, trade reports, and tick streaming.
            \item \textbf{Event Timeline}: Visual log display of system events for easy debugging.
        \end{itemize}
